...
const WHATSAPP_NUMBER = '919172923268';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center p-3"
